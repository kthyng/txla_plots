...
saltw = d.variables['salt'][tinds,:,:]
tempw = d.variables['temp'][tinds,:,:]
pdb.set_trace()
# rhow = gsw.rho_CT()
...
sshfname = 'calcs/slope-burger.npz'
...
fig.savefig('figures/slope-burger/seasonal_mean.png', bbox_inches='tight')
