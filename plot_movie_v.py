...
for plotdate in plotdates:
    ...
    figname = 'figures/v/movies/' + datesModel[itmodel].isoformat()[0:13] + '.png'
    ...
    tracpy.plotting.background(grid=grid, ax=ax, outline=[0,0,0,0], mers=np.arange(-97, -87), merslabels=[0, 0, 1, 0], pars=np.arange(23, 32))
    ...
    cb.set_label('Surface across-shore velocity [ms$^{-1}\!$]', fontsize=13, color='0.2')
